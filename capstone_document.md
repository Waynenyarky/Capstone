...
Alaminos City is a component city in the province of Pangasinan, located in the Ilocos Region of the Philippines. It is known as the "Home of the Hundred Islands," featuring the Hundred Islands National Park composed of 124 islands off the coast of Barangay Lucap. The city is politically subdivided into 39 barangays and is governed by a mayor as local chief executive and a Sangguniang Panglungsod as its legislative body. Alaminos achieved cityhood on March 28, 2001, through Republic Act 9025.
...
Whereas the Data Gathering Techniques section explained how data were collected (the process), this section presents the data gathered—the results and findings obtained from each technique. Summaries are provided here; detailed analysis and discussion of findings are presented in Chapter 3. The interview questionnaires and sample responses are included in the Appendices below.

**Primary sources.** Primary sources are firsthand accounts or original data collected directly by the researcher.

*Findings from the interviews.* The BPLO officer validated the workflow, fee computation rules (25% surcharge and 2% monthly interest for late renewal), and pre-requirements (CTC, Barangay Clearance, PIS, DTI or SEC). He reported that BPLO encoding takes approximately 20 minutes when complete, but the full process with inspections extends to 2–4 weeks or longer. Common applicant errors include missing barangay clearance, wrong tax code, and incomplete address; an estimated 30–40% of applications are returned. Inspection coordination is manual, with no shared system. The business owner reported 5–6 office visits over approximately 3 weeks for new permits, duplicate document submissions, lack of status visibility, and costs of roughly PHP 500–800 on transportation and PHP 200–300 on photocopying. Overall satisfaction with the current process was rated 2–3 out of 5. The mayor's assistant emphasized permit processing efficiency, oversight needs, and transparency as administrative priorities.

*Findings from the observation.* The observation at the Business One-Stop Shop confirmed the physical layout, document flow, applicant–officer interaction, and manual coordination among offices (phone calls, manual handoff). It verified the absence of a centralized digital system and reliance on paper-based workflows.
