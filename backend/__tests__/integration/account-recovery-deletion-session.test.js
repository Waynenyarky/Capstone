...
describe('Account Recovery, Deletion & Session Management', () => {
  ...
  beforeAll(async () => {
    ...
    const { app: appInstance } = require('../../services/auth-service/src/index')
    app = appInstance
  })
  ...
  describe('8. High-Privilege Task Checking', () => {
    test('should check for high-privilege tasks', async () => {
      const { checkHighPrivilegeTasks } = require('../../services/auth-service/src/lib/highPrivilegeTaskChecker')
  ...
  describe('9. IP Tracking', () => {
    test('should track IP addresses', async () => {
      const { trackIP, getRecentIPs } = require('../../services/auth-service/src/lib/ipTracker')
    ...
    test('should detect unusual IP', async () => {
      ...
      const { isUnusualIP } = require('../../services/auth-service/src/lib/ipTracker')
