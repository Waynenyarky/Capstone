...
describe('Audit Logger Service', () => {
  ...
  describe('calculateAuditHash', () => {
    ...
    it('should include all fields in hash calculation', async () => {
      const timestamp = '2024-01-01T00:00:00.000Z'
      const metadata = { ip: '127.0.0.1', userAgent: 'test-agent', extra: 'data' }
  ...
  describe('Complex Scenarios', () => {
    it('should handle concurrent audit log creation', async () => {
      ...
      const validEventTypes = ['login', 'logout', 'signup', 'profile_update', 'password_change', 'mfa_enabled', 'mfa_disabled', 'security_event', 'login_failed', 'session_timeout']
      const promises = []
    ...
    it('should handle audit log lifecycle', async () => {
      ...
      const allLogs = await AuditLog.find({ userId: testUserId }).sort({ createdAt: 1 })
  ...
  describe('Security and Compliance', () => {
    ...
    it('should handle security events', async () => {
      ...
      const securityEvents = ['security_event', 'login_failed', 'account_lockout', 'restricted_field_attempt']
