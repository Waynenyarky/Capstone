...
describe('Auth Notification Service', () => {
  ...
  describe('markAsRead', () => {
    ...
    it('should mark notification as read', async () => {
      const result = await notificationService.markAsRead(testNotification._id, testUserId)
  ...
  describe('deleteNotification', () => {
    ...
    it('should delete notification successfully', async () => {
      const result = await notificationService.deleteNotification(testNotification._id, testUserId)
    ...
    it('should throw error when trying to delete another user\'s notification', async () => {
      ...
      await expect(
        notificationService.deleteNotification(testNotification._id, otherUserId)
      ).rejects.toThrow('Notification not found or access denied')
    })
  })
  ...
  describe('deleteAllForUser', () => {
    ...
    it('should delete all notifications for user', async () => {
      ...
      const remainingNotifications = await Notification.find({ userId: testUserId })
    ...
    it('should not affect other users\' notifications', async () => {
      ...
      const otherUserNotifications = await Notification.find({ userId: '507f1f77bcf86cd799439012' })
  ...
  describe('deleteNotificationsOlderThan', () => {
    ...
    it('should delete notifications older than specified days', async () => {
      const result = await notificationService.deleteNotificationsOlderThan(testUserId, 7)
    ...
    it('should use default 7 days when no days specified', async () => {
      const result = await notificationService.deleteNotificationsOlderThan(testUserId)

      expect(result.deletedCount).toBe(1)
    })

    it('should delete all when all notifications are old', async () => {
      const result = await notificationService.deleteNotificationsOlderThan(testUserId, 1)
  ...
  describe('Error Handling', () => {
    it('should handle database connection errors gracefully', async () => {
      ...
      Notification.create = vi.fn().mockRejectedValue(new Error('Database connection failed'))

      await expect(
        notificationService.createNotification(testUserId, 'general', 'Test', 'Message')
      ).rejects.toThrow('Failed to create notification')
  ...
  describe('Complex Scenarios', () => {
    it('should handle notification lifecycle workflow', async () => {
      ...
      // Mark as read
      const markedNotification = await notificationService.markAsRead(notification._id, testUserId)
      ...
      // Delete notification
      await notificationService.deleteNotification(notification._id, testUserId)
    ...
    it('should handle bulk operations correctly', async () => {
      ...
      // Delete all for user
      const deleteAllResult = await notificationService.deleteAllForUser(testUserId)
