...
describe('Password Expiry Service', () => {
  describe('isPasswordExpired', () => {
    ...
    it('should handle string dates', () => {
      const oldDateString = new Date(Date.now() - 91 * 24 * 60 * 60 * 1000).toISOString()
  ...
  describe('isPasswordExpiredByPolicy', () => {
    ...
    it('should return false for invalid date', () => {
      expect(passwordExpiry.isPasswordExpiredByPolicy('invalid-date')).toBe(false)
    ...
    it('should return false for passwords exactly 90 days old', () => {
      const exactly90Days = new Date(Date.now() - 90 * 24 * 60 * 60 * 1000)
      expect(passwordExpiry.isPasswordExpiredByPolicy(exactly90Days)).toBe(false)
    })
    ...
    it('should handle string dates', () => {
      const oldDateString = new Date(Date.now() - 91 * 24 * 60 * 60 * 1000).toISOString()
      expect(passwordExpiry.isPasswordExpiredByPolicy(oldDateString)).toBe(true)
    })
  })
