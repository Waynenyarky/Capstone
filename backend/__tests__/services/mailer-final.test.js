...
describe('Mailer Service - Final Working Version', () => {
  let originalEnv
  let mockAxiosPost
  ...
  describe('Core Functionality', () => {
    it('should send OTP email successfully', async () => {
      ...
      // Should succeed either way (real API or mock)
  ...
  describe('Email Content', () => {
    it('should generate valid email content', async () => {
      ...
      expect(result).toBeDefined()
      // Content validation is handled internally by the mailer service
    })
    ...
    it('should include brand information', async () => {
      ...
      expect(result).toBeDefined()
      // Brand info is included in the HTML template
    })
  })
})
