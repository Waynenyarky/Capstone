...
describe('Verification Service - Final Working Version', () => {
  let mongo
  let testUser
  let testUserId
  ...
  beforeEach(() => {
    ...
    const { checkLockout, incrementFailedAttempts, clearFailedAttempts } = 
  ...
  describe('Core OTP Functionality', () => {
    ...
    it('should handle verification status checking', async () => {
      await verificationService.requestVerification(testUserId, 'otp', 'profile_change')
    ...
    it('should clear verification requests', async () => {
      await verificationService.requestVerification(testUserId, 'otp', 'profile_change')
  ...
  describe('Security Features', () => {
    ...
    it('should handle different purposes correctly', async () => {
      ...
      for (const purpose of purposes) {
        const result = await verificationService.requestVerification(testUserId, 'otp', purpose)
        // Some purposes might fail due to state, just check it doesn't crash
        expect(result).toBeDefined()
        
        // Check that sendOtp was called (if successful)
        if (result.success) {
