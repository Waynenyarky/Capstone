...
const calculateAuditHash = require('../src/lib/auditLogger').calculateAuditHash
const AuditLog = require('../src/models/AuditLog')
const TamperIncident = require('../src/models/TamperIncident')
const Role = require('../src/models/Role')
const User = require('../src/models/User')
const verifyAuditIntegrity = require('../src/jobs/verifyAuditIntegrity')
