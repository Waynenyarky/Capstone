...
const {
  ...
  isAdminRole,
  isBusinessOwnerRole,
} = require("../../services/auth-service/src/lib/roleHelpers");
const {
  checkFieldPermission,
} = require("../../services/auth-service/src/middleware/fieldPermissions");
const {
  alertRestrictedFieldAttempt,
} = require("../../services/admin-service/src/lib/adminAlertService");
  ...
  describe("7. Admin Approval Endpoints", () => {
    ...
    it("should prevent self-approval", async () => {
      ...
      if (response.status === 400) {
        ...
        expect(["self_approval_not_allowed", "validation_error"]).toContain(
          errorCode,
        );
