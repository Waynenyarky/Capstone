...
const { flagBusinessesForRenewal, calculateMonthlyInterest } = require('../../../services/business-service/src/cron/renewalAutoFlag')
const { detectAbandonedBusinesses, markBusinessAbandoned } = require('../../../services/business-service/src/cron/abandonedDetection')
...
describe('Renewal Auto-Flag Cron (2E)', () => {
  ...
  it('should skip inactive businesses', async () => {
    await createProfile([{ businessName: 'Inactive', businessStatus: 'inactive' }])
