...
async function setupUsers() {
  ...
  managerToken = signAccessToken({ ...manager.toObject(), role: managerRole }).token
}
...
describe('Appeals (2K)', () => {
  ...
  describe('UC-2K-2: Manager resolves appeal', () => {
    it('should approve appeal with resolution', async () => {
      ...
      expect(res.body.data.resolution).toBe('Fee has been corrected. Refund will be processed.')
