...
const getMockVerifyReg = () => global.__webauthnMockVerifyReg || mockVerifyRegistrationResponse
...
describe('Passkey (WebAuthn) Tests', () => {
  ...
  beforeAll(async () => {
    ...
    Object.keys(require.cache).forEach(key => {
      if (key.includes('webauthn') || key.includes('auth-service/src/routes') || key.includes('auth-service/src/index')) {
