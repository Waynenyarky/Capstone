...
} = require("../../services/auth-service/src/lib/notificationService");
const {
  getUserFriendlyMessage,
  createSafeErrorResponse,
  handleValidationError,
} = require("../../services/auth-service/src/lib/errorHandler");
...
describe("Phase 3: User Experience", () => {
  ...
  describe("1. Email Change Grace Period", () => {
    ...
    it("should get email change status", async () => {
      ...
      expect(response.body.emailChangeRequest.remainingHours).toBeGreaterThan(
        0,
      );
  ...
  describe("2. Email Revert Functionality", () => {
    it("should revert email change within grace period", async () => {
      ...
      const updatedRequest = await EmailChangeRequest.findById(
        emailChangeRequest._id,
      );
