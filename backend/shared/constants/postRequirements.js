...
const POST_REQUIREMENT_TYPES = {
  ...
  building_clearance: {
    ...
    label: "Building Clearance / Occupancy Permit",
  },
};
...
const NEW_PERMIT_REQUIREMENT_VALUES = NEW_PERMIT_REQUIREMENTS.map(
  (r) => r.value,
);
const RENEWAL_PERMIT_REQUIREMENT_VALUES = RENEWAL_PERMIT_REQUIREMENTS.map(
  (r) => r.value,
);
