...
if (arg === "roles") {
  const roles = [
    {
      role: "LGU Officer",
      email: "bizclear-officer@mailinator.com",
      inbox: "bizclear-officer",
    },
    {
      role: "Manager",
      email: "bizclear-manager@mailinator.com",
      inbox: "bizclear-manager",
    },
    {
      role: "Admin",
      email: "bizclear-admin@mailinator.com",
      inbox: "bizclear-admin",
    },
    {
      role: "Admin 2",
      email: "bizclear-admin2@mailinator.com",
      inbox: "bizclear-admin2",
    },
    {
      role: "Admin 3",
      email: "bizclear-admin3@mailinator.com",
      inbox: "bizclear-admin3",
    },
  ];
  console.log("");
  ...
  console.log("");
  console.log(
    "Then ensure SEED_DEV=true and restart auth service so seed runs.",
  );
  console.log(
    "Read OTPs at https://www.mailinator.com (enter inbox name above).",
  );
  console.log("");
  process.exit(0);
}
...
console.log("");
console.log(
  "To read messages: open https://www.mailinator.com and enter inbox: " + local,
);
console.log("");
