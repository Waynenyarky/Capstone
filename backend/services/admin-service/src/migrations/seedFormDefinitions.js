...
const globalCessationSections = [
  {
    ...
    items: [
      ...
      item(
        "BIR Certificate of Registration (Form 2303) with cancellation stamp",
        "file",
        {
    ...
    items: [
      item("Violation type", "select", {
        ...
        dropdownOptions: [
          ...
          "Business name change not reported",
          "Other",
        ],
      }),
...
const unifiedBusinessPermitSections = [
  {
    ...
    notes:
      "Supporting documents for the unified business permit application. Applicant/owner details are taken from the PIS (account registration).",
    items: [
      item("Valid government-issued ID of the business owner", "file", {
        key: "ownerGovernmentId",
        helpText:
          "Upload a clear scan or photo of a valid government-issued ID (e.g. Philippine passport, driver's license, SSS UMID, PhilSys national ID). Owner details are from your account.",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      ...
      item("DTI / SEC / CDA Certificate of Registration", "file", {
        ...
        helpText:
          "DTI for sole proprietorship, SEC for corporation/partnership, CDA for cooperatives",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("Lease contract or land title", "file", {
        ...
        required: false,
        helpText:
          "Proof of right to use the business premises (lease, contract of sale, or land title). Required if property is leased.",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      ...
      item("Occupancy Permit", "file", {
        ...
        required: false,
        helpText:
          "Required for establishments with physical premises; issued by the Building Official",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
    ],
  },
  ...
  },
  {
    ...
    notes:
      "Describe what your business sells or does, then click Analyze to get suggestions. You may answer in Filipino or English.",
    items: [
      item("What does your business sell or do?", "ai_lob_recommendation", {
        key: "aiLobRecommendation",
        helpText: "",
        placeholder:
          "e.g. Sari-sari store selling groceries and snacks / Nagtitinda ako ng pagkain at groceries sa maliit kong tindahan",
  ...
  },
  {
    ...
    items: [
      ...
      item("Monthly rental (if leased)", "number", {
        ...
        placeholder: "0.00",
        helpText:
          "Monthly rental amount in pesos (required if property is leased)",
        validation: { minValue: 0 },
        span: 12,
      }),
      ...
      item("Lessor address", "address_alaminos", {
        ...
        required: false,
        helpText:
          "Address of the lessor / property owner (Alaminos City, required if leased)",
      }),
    ],
  },
  {
    ...
    notes:
      "Building and list of machineries, equipment, and delivery vehicles used in the business.",
    items: [
      ...
      item("Machineries / equipment / vehicles", "repeatable_group", {
        ...
        helpText:
          'Add one row for each machinery, equipment, or delivery vehicle. Click "Add row" to add more.',
        required: false,
        groupFields: [
          {
  ...
  },
  {
    ...
    notes:
      "List any accreditations, licenses, or special permits held by the business from government agencies.",
    items: [
      item("Accreditations / licenses", "repeatable_group", {
        key: "accreditationsLicenses",
        helpText:
          'Add one row for each accreditation or license. Click "Add row" to add more.',
        required: false,
        groupFields: [
          {
            ...
            helpText:
              "Government agency that issued the accreditation or license",
            span: 8,
            validation: { minLength: 1, maxLength: 200 },
            dropdownSource: "static",
            dropdownOptions: [
  ...
  },
  {
    ...
    notes:
      "The applicant must certify that all information provided is true and correct.",
    items: [
      item(
        ...
        "checkbox",
        {
          ...
          required: true,
          helpText:
            "You must agree to the oath of undertaking to proceed with the application.",
...
const generalPermitSections = [
  {
    ...
    items: [
      ...
      item("Location of activity", "address_alaminos", {
        ...
        helpText:
          "Where the business activity or stall will be located (Alaminos City)",
      }),
      item("Duration of activity", "text", {
        ...
        helpText:
          "For temporary permits (bazaar, festival, etc.), specify the dates",
        validation: { maxLength: 200 },
      }),
  ...
  // ─── Category-specific requirements (CBPLO-GPI-F06 per Alaminos requirements) ───
  {
    ...
    notes:
      "Before processing: PIS, CTC, Barangay Clearance, CDA Registration (new), Certificate of Compliance from City Cooperatives Office, SPA/Authorization, Lease + Mayor's Permit of Lessor (if lessee). During: Application Form, Receipt of Payment.",
    ...
    items: [
      ...
      item("Cooperative Development Authority Registration (for NEW)", "file", {
        key: "cdaRegistration",
        required: false,
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("Certificate of Compliance from City Cooperatives Office", "file", {
        key: "cityCooperativesCompliance",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("SPA or Authorization letter of Representative", "file", {
        key: "spaOrAuthLetter",
        required: false,
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
  ...
  },
  {
    ...
    notes:
      "Before: PIS, CTC, Barangay Clearance, SEC/DOLE Registration, SPA/Authorization. During: Application Form, Receipt of Payment, Real Property Tax Clearance, Account Clearance (renewal).",
    showWhen: {
      field: "generalPermitCategory",
    ...
    items: [
      ...
      item("SEC / DOLE Registration", "file", {
        key: "secDoleRegistration",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("SPA or Authorization letter of Representative", "file", {
        key: "spaOrAuthLetter",
      ...
      item("Real Property Tax Clearance", "file", {
        key: "rptClearance",
        required: false,
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("Account Clearance (for Renewal)", "file", {
  ...
  },
  {
    ...
    notes:
      "Before: PIS, CTC, Barangay Clearance, Certification of Chainsaw Ownership, Stencil of Chainsaw Serial No. During: Application Form, Receipt of Payment, RPT Clearance, Account Clearance (renewal).",
  ...
  },
  {
    ...
    items: [
      ...
      item(
        ...
        "file",
        {
          key: "campCrameLicense",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        },
      ),
      item(
        "Authorization/Certification of Dealers/Licensee of Source",
        "file",
        {
          key: "dealerAuthorization",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        },
      ),
      item("Fireworks Retailers Seminar Certificate", "file", {
        key: "fireworksSeminarCert",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item("Fire Safety Inspection Certificate from BFP", "file", {
        key: "bfpFireSafetyCert",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
    ],
  },
  {
    ...
    notes:
      "PIS, CTC, Barangay Clearance, Certification from City Tourism Office (Lucap Wharf only), Letter of Approval by City Market and Cemetery Section Head with assessment of fees, Application Form, Receipt of Payment.",
    showWhen: {
      field: "generalPermitCategory",
      values: ["bazaar_festival_vendors", "peddlers"],
    },
    items: [
      item("Community Tax Certificate (CTC)", "file", {
        key: "ctc",
      ...
      item(
        "Certification from City Tourism Office (Lucap Wharf only)",
        "file",
        {
          key: "tourismCert",
          required: false,
  ...
  },
  {
    ...
    notes:
      "PIS of requesting party, Request letter approved by City Administrator, Letter of Approval by City Market and Cemetery Section Head with assessment of fees.",
    showWhen: {
      field: "generalPermitCategory",
      value: "promotions_exhibitors",
    },
    items: [
      item("Request letter approved by City Administrator", "file", {
        key: "requestLetterApproved",
        validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
      }),
      item(
        "Letter of Approval by City Market and Cemetery Section Head with assessment of fees",
  ...
  },
  {
    ...
    notes:
      "PIS, CTC, Barangay Clearance, Letter of Approval (City Market and Cemetery Section) with assessment, Application Form, Receipt of Payment.",
    showWhen: {
      field: "generalPermitCategory",
      value: "cemetery_stallholders",
    },
    items: [
      item("Community Tax Certificate (CTC)", "file", {
        key: "ctc",
  ...
  },
  {
    ...
    notes:
      "Before: PIS, CTC, Barangay Clearance, Certification from Brgy. Captain & CFARMC Chairman, Certification from City Agriculturist, Contract of Lease (NEW), Assessment of fees. During: Application Form, Receipt of Payment, RPT Clearance, Account Clearance (renewal).",
  ...
  },
  {
    ...
    notes:
      "Before: PIS, CTC, Barangay Clearance, Tax Declaration of property (photocopy), Assessment of fees. During: Application Form, Receipt of Payment, RPT Clearance, Account Clearance (renewal).",
...
const occupationalPermitSections = [
  {
    ...
    notes:
      "Applicant personal data for the Mayor's Permit for Occupation application",
    items: [
  ...
  },
  {
    ...
    notes:
      "Name of school, inclusive dates, and degree/course/strand per level",
    items: [
      item("Educational background", "repeatable_group", {
        key: "educationalBackground",
        helpText:
          "Add one row per level: Elementary, Secondary, Vocational, College, Post Graduate",
        groupFields: [
          {
            label: "Level",
            type: "select",
  ...
  },
  {
    ...
    notes:
      "Select whether applicant is a food handler or non-food handler; this determines which laboratory exams are required.",
    items: [
      item("Occupation type", "select", {
        key: "occupationType",
        helpText:
          "Food handler: lab exams include Urinalysis, Fecalysis, Hepa B, Chest X-Ray. Non-food handler: Drug Test, Chest X-Ray.",
        placeholder: "Select type",
  ...
  },
  {
    category: "Required Documents",
    notes:
      "Barangay Clearance, Community Tax Certificate, PIS Registration at MIS Office",
    items: [
  ...
  },
  {
    ...
    notes:
      "Required for food handlers: Urinalysis, Fecalysis, Hepa B Screening Test, Chest X-Ray",
...
const industrySections = {
  a: [
    // Agriculture, forestry and fishing
    {
      ...
      items: [
        item(
          "Bureau of Fisheries and Aquatic Resources (BFAR) permit",
          "file",
          {
            required: false,
            helpText:
              "Required for fishing, aquaculture, and fish trading businesses",
            validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
          },
        ),
        item(
          "DA / Bureau of Plant Industry (BPI) phytosanitary certificate",
          "file",
          {
            required: false,
            helpText:
              "Required for plant nurseries, seed dealers, and agricultural product exporters",
            validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
          },
        ),
        item("DENR permit for forestry activities", "file", {
          required: false,
          helpText:
            "Required for logging, wood processing, and NTFP collection",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Fertilizer and Pesticide Authority (FPA) license", "file", {
          required: false,
          helpText:
            "Required for dealers/distributors of fertilizers and pesticides",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Manufacturing
    {
      ...
      items: [
        item("DENR Environmental Compliance Certificate (ECC)", "file", {
          required: false,
          helpText:
            "Required for environmentally critical projects (ECP) or projects in ECAs",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Pollution Control Officer (PCO) accreditation", "file", {
          required: false,
          helpText:
            "Factories generating pollution must designate an accredited PCO",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Waste disposal agreement or proof of disposal service", "file", {
          helpText:
            "Contract with a DENR-accredited waste hauler/treatment facility",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("FDA License to Operate (LTO)", "file", {
          required: false,
          helpText:
            "Required for food, drug, cosmetic, and medical device manufacturers",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("DOLE safety compliance certificate", "file", {
          required: false,
          helpText:
            "Required for factories with hazardous work environments per DO 198-18",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
  ...
  d: [
    // Electricity, gas, steam
    {
      ...
      source: "DOE",
      notes:
        "Department of Energy and Energy Regulatory Commission requirements",
      items: [
        item("DOE Certificate of Compliance", "file", {
          helpText:
            "Required for power generation, distribution, and retail electricity suppliers",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("ERC franchise / Certificate of Public Convenience", "file", {
          required: false,
          helpText:
            "For distribution utilities and retail electricity suppliers",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Environmental Compliance Certificate (ECC)", "file", {
          required: false,
    ...
    // Water supply, sewerage, waste management
    {
      ...
      items: [
        ...
        item("DENR Hazardous Waste Generator ID", "file", {
          required: false,
          helpText:
            "Required for businesses generating hazardous waste (RA 6969)",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Water permit from NWRB", "file", {
          required: false,
          helpText:
            "National Water Resources Board permit for water extraction/supply",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Environmental Compliance Certificate (ECC)", "file", {
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
  ...
  f: [
    // Construction
    {
      ...
      source: "PCAB",
      notes:
        "Philippine Contractors Accreditation Board and related requirements",
      items: [
        item("PCAB License", "file", {
          required: false,
          helpText:
            "Required for contractors; classification determines allowable project value",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Building Permit", "file", {
          required: false,
          helpText:
            "From the LGU Building Official, required before starting construction",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Professional Regulation Commission (PRC) licenses", "file", {
          required: false,
          helpText:
            "Engineer/Architect licenses for regulated design and construction work",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Environmental Compliance Certificate (ECC)", "file", {
          required: false,
          helpText:
            "Required for environmentally critical construction projects",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Wholesale and retail trade
    {
      ...
      items: [
        ...
        item("Product standards certification (if applicable)", "file", {
          required: false,
          helpText:
            "Philippine Standard (PS) or Import Commodity Clearance (ICC) mark for regulated products",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
  ...
  h: [
    // Transport and storage
    {
      ...
      source: "LTFRB",
      notes:
        "Land Transportation Franchising and Regulatory Board requirements",
      items: [
        item("LTFRB Certificate of Public Convenience (CPC)", "file", {
          required: false,
          helpText:
            "Required for public utility vehicles (buses, jeepneys, UV express, taxis, TNVS)",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("LTO vehicle registration (OR/CR)", "file", {
          helpText:
            "Official receipt and certificate of registration for each vehicle",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Professional driver license copies", "file", {
          helpText:
            "Professional driver's license with appropriate restriction code",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("CAB permit (for airlines)", "file", {
          required: false,
          helpText:
            "Civil Aeronautics Board permit for domestic/international air transport",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("MARINA registration (for maritime transport)", "file", {
          required: false,
          helpText:
            "Maritime Industry Authority registration for shipping/maritime businesses",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Accommodation and food service
    {
      ...
      items: [
        item("Sanitary Permit", "file", {
          helpText:
            "Issued by the City/Municipal Health Office after sanitary inspection",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("Health certificates for food handlers", "file", {
          helpText:
            "Individual health certificates for all food-handling employees",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        ...
        item("FDA License to Operate (LTO)", "file", {
          required: false,
          helpText:
            "Required for food manufacturers, food supplement distributors",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("DOT Accreditation (for accommodation)", "file", {
          required: false,
          helpText:
            "Department of Tourism accreditation for hotels, resorts, inns",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Information and communication
    {
      ...
      items: [
        item("NTC franchise/permit (for telecom operators)", "file", {
          required: false,
          helpText:
            "Required for telecommunications providers and value-added service providers",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("NPC registration (data processing)", "file", {
          required: false,
          helpText:
            "National Privacy Commission registration for personal information controllers/processors under RA 10173",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
  ...
  k: [
    // Financial and insurance activities
    {
      ...
      source: "BSP",
      notes:
        "Bangko Sentral ng Pilipinas, SEC, and Insurance Commission requirements",
      items: [
        ...
        item("BSP license/authority to operate (banking)", "file", {
          required: false,
          helpText:
            "Required for banks, quasi-banks, trust entities, and money service businesses",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        ...
        item("AMLC registration (anti-money laundering)", "file", {
          required: false,
          helpText:
            "Registration with the Anti-Money Laundering Council for covered institutions",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Real estate activities
    {
      ...
      items: [
        ...
        item("DHSUD (HLURB) License to Sell", "file", {
          required: false,
          helpText:
            "Required for real estate developers selling subdivision lots or condominium units",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Administrative and support service activities
    {
      ...
      items: [
        item("DOLE registration (for manpower agencies)", "file", {
          required: false,
          helpText:
            "Required for private recruitment and placement agencies per DO 174-17",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
    ...
    // Public administration and defence
    {
      ...
      items: [
        item("PhilGEPS registration", "file", {
          required: false,
          helpText:
            "Philippine Government Electronic Procurement System registration for government suppliers",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Human health and social work activities
    {
      ...
      items: [
        item("DOH License to Operate (LTO) health facility", "file", {
          helpText:
            "Required for hospitals, clinics, laboratories, pharmacies, etc.",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        ...
        item("Dangerous Drugs Board (DDB) license (pharmacies)", "file", {
          required: false,
          helpText:
            "Required for pharmacies handling regulated drugs per RA 9165",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("DSWD license (social work institutions)", "file", {
          required: false,
          helpText:
            "Required for social welfare agencies, child-caring institutions",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Arts, entertainment and recreation
    {
      ...
      items: [
        item("Special Permit for amusement/entertainment (LGU)", "file", {
          required: false,
          helpText:
            "Required for bars, KTV, gaming, amusement arcades, resorts, etc.",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("DOT accreditation (tourism-related)", "file", {
          required: false,
          helpText:
            "Department of Tourism accreditation for tourism enterprises",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("PAGCOR license (gaming operations)", "file", {
          required: false,
          helpText:
            "Philippine Amusement and Gaming Corporation license for gaming establishments",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Other service activities
    {
      ...
      items: [
        item("Special permit for personal care services", "file", {
          required: false,
          helpText:
            "E.g. beauty salons, barbershops, laundry services, funeral services",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
        item("DENR permit (automotive repair / car wash)", "file", {
          required: false,
          helpText:
            "Environmental permit for wastewater-generating service activities",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
      ],
    },
    ...
    // Activities of households as employers
    {
      ...
      items: [
        item("Kasambahay employment contract", "download", {
          helpText:
            "Standardized employment contract per RA 10361 (Batas Kasambahay)",
        ...
        item(
          "SSS / PhilHealth / Pag-IBIG registration for domestic worker",
          "file",
          {
            helpText:
              "Employer must register domestic workers with mandatory agencies",
            validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
          },
        ),
      ],
    ...
    // Extraterritorial organizations
    {
      ...
      items: [
        item("SEC registration as foreign corporation", "file", {
          required: false,
          helpText:
            "License to do business in the Philippines for foreign entities",
          validation: { acceptedFileTypes: "pdf,jpg,png", maxFileSize: 10 },
        }),
...
// ─── Seed function ────────────────────────────────────────────────
async function createFormGroupAndDefinition({
  formType,
  industryScope,
  sections,
  version = "2026.1",
  now,
  addArchivedVersion = false,
}) {
  const scopeLabel =
    industryScope === "all"
      ? "All Industries"
      : INDUSTRY_SCOPE_LABELS[industryScope] || industryScope;
  const typeLabels = {
    ...
    changeLog: [
      {
        ...
        system: "Seeder",
        at: now,
        changes: { note: "Seeded from Philippine government requirements" },
      },
      {
        action: "published",
        by: SYSTEM_USER_ID,
        system: "Seeder",
        at: now,
        changes: { note: "Auto-published as seed data" },
      },
    ],
  });
      ...
      changeLog: [
        {
          ...
          system: "Seeder",
          at: archivedFrom,
          changes: { note: "Seeded legacy version" },
        },
        {
          action: "archived",
          by: SYSTEM_USER_ID,
          system: "Seeder",
          at: archivedTo,
          changes: { note: "Superseded by current version" },
        },
      ],
    });
  }
...
async function seed() {
  ...
  try {
    ...
    if (existingCount > 0) {
      console.log(
        `Found ${existingCount} existing form definitions. Skipping seed.`,
      );
      console.log(
        "To re-seed, drop the FormDefinition and FormGroup collections first.",
      );
...
async function seedIfEmpty() {
  try {
    ...
    if (existingCount > 0) {
      console.log(
        `[FormDefinitions] ${existingCount} definitions already exist. Skipping seed.`,
      );
      return { seeded: false, count: existingCount };
    }

    console.log(
      "[FormDefinitions] No definitions found. Seeding initial data...",
    );
    const now = new Date();
    let count = 0;
    ...
    console.log(
      `[FormDefinitions] Seeded ${count} form definitions successfully.`,
    );
