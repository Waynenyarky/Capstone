  ...
  async generateRequirementsChecklistPDF() {
    return new Promise((resolve, reject) => {
      try {
        ...
        // Draw the box first
        doc
          .roundedRect(titleBoxX, titleY, titleBoxWidth, titleBoxHeight, 3)
          .strokeColor("#000000")
          .lineWidth(1.5)
          .stroke();
        ...
        doc
          ...
          .fillColor("#000000")
          .text(
            "For New Business Registration Application",
            titleBoxX,
            subtitleTextY,
            {
              align: "center",
        ...
        doc
          ...
          .font("Helvetica")
          .fillColor("#333333")
          .text(`Document No.: ${docNumber}`, margin + 15, doc.y, {
            continued: true,
          })
          .text(`Date Issued: ${docDate}`, { align: "right" });

        doc.moveDown(0.2);
        doc.text(`Time Generated: ${docTime}`, margin + 15, doc.y, {
          continued: true,
        });
        ...
        doc
          ...
          .font("Helvetica-Bold")
          .fillColor("#000000")
          .text("B. BUREAU OF INTERNAL REVENUE (BIR) REQUIREMENTS", {
            indent: 0,
          })
          .moveDown(0.2);
        ...
        doc
          ...
          .fillColor("#000000")
          .text(
            "C. OTHER GOVERNMENT AGENCIES (If Applicable – With Employees)",
            { indent: 0 },
          )
          .moveDown(0.2);
        ...
        doc
          ...
          .font("Helvetica")
          .fillColor("#000000")
          .text("If your business has employees, you must register with:", {
            indent: 0,
          })
          .moveDown(0.2);
        ...
        const noticeY = doc.y;
        doc
          .roundedRect(margin + 10, noticeY, contentWidth - 20, 32, 3)
          .strokeColor("#000000")
          .lineWidth(1)
          .fillColor("#f8f8f8")
          .fill()
        ...
        doc
          ...
          .fillColor("#333333")
          .text(
            "Please prepare all required documents before proceeding with the online application.",
            {
              align: "center",
              y: noticeY + 18,
        ...
        doc
          ...
          .fillColor("#666666")
          .text(
            "This is an official document generated by the Local Government Unit",
            { align: "center" },
          )
          .moveDown(0.2)
          .text(
            "For inquiries, please contact the Business Permit and Licensing Office",
            { align: "center" },
          )
          .moveDown(0.2)
          .text(
            `Document Reference: ${docNumber} | Generated: ${docDate} at ${docTime}`,
            { align: "center" },
          );
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        doc
          ...
          .fillColor("#333333")
          .text(
            "Please ensure all documents are current and valid. Submit complete requirements before the deadline to avoid penalties.",
            {
              align: "center",
              y: noticeY + 18,
              width: contentWidth - 40,
