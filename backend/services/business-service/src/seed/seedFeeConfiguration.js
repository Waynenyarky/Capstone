...
function entry(taxCode, lineOfBusiness, mayorsPermitFee, businessTaxCategory, bracketKey, environmentalProtectionFee = null, barangayClearanceFee = null) {
...
const SEED_DATA = [
  ...
  entry('1', 'Plastic/Vinyl Manufacturing', 12000, TAX_CAT.a, 'manufacturer', 6000),
  ...
  entry('2', 'Gas/Chemical/Refilling Plant', 9000, TAX_CAT.a, 'manufacturer', 3600),
  ...
  entry('3', 'Dental/Optical/Veterinary/Other Clinics', 1440, TAX_CAT.h, 'retail'),
  entry('3', 'Hospitals', 3600, TAX_CAT.h, 'retail'),
  entry('3', 'Lying-In Clinics', 1800, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (non-stock & non-profit) - Less than 100 enrollees', 2200, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (non-stock & non-profit) - 100 to 499 enrollees', 3000, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (non-stock & non-profit) - 500 or more enrollees', 3600, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (taxable) - Less than 100 enrollees', 1200, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (taxable) - 100 to 499 enrollees', 1800, TAX_CAT.h, 'retail'),
  entry('3', 'Private Schools (taxable) - 500 or more enrollees', 2200, TAX_CAT.h, 'retail'),

  // (4) Public Market Stalls
  entry('4', 'Wet Section/Tiles', 1440, TAX_CAT.d, 'retail'),
  entry('4', 'Grocery: Dry goods & others - Small (5-6 sq.m.)', 1200, TAX_CAT.d, 'retail'),
  entry('4', 'Grocery: Dry goods & others - Medium (7-11 sq.m.)', 1320, TAX_CAT.d, 'retail'),
  entry('4', 'Grocery: Dry goods & others - Big (12-12.5 sq.m.)', 1440, TAX_CAT.d, 'retail'),

  // (5) Rentals
  entry('5', 'Apartments/Boarding Houses - 8 rooms below', 1200, TAX_CAT.h, 'retail'),
  entry('5', 'Apartments/Boarding Houses - 8 rooms above', 1800, TAX_CAT.h, 'retail'),
  ...
  entry('5', 'Video CD/Tape Rentals, Chairs/Tables Rentals', 1200, TAX_CAT.h, 'retail'),
  entry('5', 'Computer Center, Internet Café and Similar Activities - Less than 10 computers', 1440, TAX_CAT.h, 'retail'),
  entry('5', 'Computer Center, Internet Café and Similar Activities - 10 computers above', 1800, TAX_CAT.h, 'retail'),

  // (6) Food Industries
  entry('6', 'Canteens, Eateries, Food Stands, Bakeries, Catering Services - Less than 8 sq.m.', 600, TAX_CAT.h, 'retail'),
  entry('6', 'Canteens, Eateries, Food Stands, Bakeries, Catering Services - Above 8 sq.m.', 1200, TAX_CAT.h, 'retail'),
  ...
  entry('6', 'Other food and catering related establishments', 1200, TAX_CAT.h, 'retail'),
  ...
  entry('7', 'Pawnshop, Lending Investor, Investment Company', 2400, TAX_CAT.f, 'bank'),
  entry('7', 'Payment Center', 1440, TAX_CAT.f, 'bank'),

  // (8) Agricultural
  entry('8', 'Agri-supply/Poultry Feeds/Veterinary Supply/Flower Shop', 1200, TAX_CAT.d, 'retail'),
  entry('8', 'Poultry Farms/Piggery/Fish Pen', 1800, TAX_CAT.d, 'retail'),
  entry('8', 'Rice Mill', 1200, TAX_CAT.d, 'retail'),
  entry('8', 'Other farming and agricultural related establishments', 1800, TAX_CAT.d, 'retail'),

  // (9) Contractor
  entry('9', 'Consultancy and other similar offices', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Advertising Shop/Sign/Artworks', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Beauty Parlor, Barber Shop, Massage/Fitness Center', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Brokerage', 1800, TAX_CAT.e, 'contractor'),
  entry('9', 'Electronics/Garments and other sub-contractor - Below 50 sq.m.', 1800, TAX_CAT.e, 'contractor'),
  entry('9', 'Electronics/Garments and other sub-contractor - Above 50 sq.m.', 3600, TAX_CAT.e, 'contractor'),
  entry('9', 'Mechanical, Electrical, Electronic Repair Shop, Plumbing, Smith', 1440, TAX_CAT.e, 'contractor'),
  entry('9', 'Funeral Services', 2400, TAX_CAT.e, 'contractor'),
  entry('9', 'Furniture Shop/Woodworks', 1440, TAX_CAT.e, 'contractor'),
  entry('9', 'General Engineering/general Building', 1800, TAX_CAT.e, 'contractor'),
  entry('9', 'Heavy Equipment Contractor', 2400, TAX_CAT.e, 'contractor'),
  entry('9', 'Machine Shop, Vulcanizing, Welding Car Care Services', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Manpower/Security Agency, General Services', 1440, TAX_CAT.e, 'contractor'),
  entry('9', 'Parking Lot', 1800, TAX_CAT.e, 'contractor'),
  entry('9', 'Photo Studio, Printing Press and Tarpaulin Shops', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Private Cemetery/Memorial Park', 6000, TAX_CAT.h, 'retail'),
  entry('9', 'Privately-Owned Market', 6000, TAX_CAT.d, 'retail'),
  entry('9', 'Subdivision Operators/Developers, Real Estate Developers', 12000, TAX_CAT.e, 'contractor'),
  entry('9', 'Scrapper', 2400, TAX_CAT.e, 'contractor'),
  entry('9', 'Tailoring, Dress Shop, Shoe Repair Shop, Upholstery, Laundry', 1200, TAX_CAT.e, 'contractor'),
  entry('9', 'Vehicle Construction', 1440, TAX_CAT.e, 'contractor'),
  entry('9', 'Vehicle Repair Shop/Services', 1440, TAX_CAT.e, 'contractor'),
  entry('9', 'Warehousing/Forwarding Establishment', 2400, TAX_CAT.e, 'contractor'),
  ...
  entry('10', 'Disco House, Beer House, Videoke Bar, Night Clubs', 1800, TAX_CAT.h, 'retail'),
  ...
  entry('11', 'Telecommunications, Tower, Cell Site', 6000, TAX_CAT.h, 'retail'),
  ...
  entry('12', 'Drug Store/Pharmacy - Below 40 sq.m.', 1200, TAX_CAT.d, 'retail'),
  entry('12', 'Drug Store/Pharmacy - Above 40 sq.m.', 2400, TAX_CAT.d, 'retail'),
  entry('12', 'Electronic/Electrical Store', 1200, TAX_CAT.d, 'retail'),
  entry('12', 'Furniture Retailing', 1800, TAX_CAT.d, 'retail'),
  entry('12', 'General Merchandise, Grocery, Sari-Sari Store - below 5 sq.m.', 300, TAX_CAT.d, 'retail'),
  entry('12', 'General Merchandise, Grocery, Sari-Sari Store - 5-9 sq.m.', 600, TAX_CAT.d, 'retail'),
  entry('12', 'General Merchandise, Grocery, Sari-Sari Store - above 10 sq.m.', 1200, TAX_CAT.d, 'retail'),
  ...
  entry('12', 'Other Retail/Dealer/Supply - Below 40 sq.m.', 1200, TAX_CAT.d, 'retail'),
  entry('12', 'Other Retail/Dealer/Supply - Above 40 sq.m.', 2400, TAX_CAT.d, 'retail'),
...
async function seed() {
  ...
  for (const row of SEED_DATA) {
    ...
    const result = await FeeConfiguration.updateOne(
      { taxCode: row.taxCode, lineOfBusiness: row.lineOfBusiness, isActive: true },
