...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      const [inspectionCount, violationCount, notificationCount] =
        await Promise.all([
      ...
      return respond.error(
        ...
        500,
        "fetch_error",
        err.message || "Failed to fetch debug info",
      );
    }
  },
);
  ...
  (req, res) => {
    try {
      ...
      return respond.error(
        ...
        500,
        "fetch_error",
        err.message || "Failed to fetch violations catalog",
      );
    }
  },
);
  ...
  (req, res) => {
    try {
      ...
      return respond.error(
        ...
        500,
        "fetch_error",
        err.message || "Failed to fetch ordinances",
      );
    }
  },
);
