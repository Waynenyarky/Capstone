...
module.exports = {
  ...
  consumeDisableRequestVerified: (userId) =>
    getAndDelete(disableRequestVerified, userId),
  setDisableUndoVerified: (userId) => set(disableUndoVerified, userId),
  consumeDisableUndoVerified: (userId) =>
    getAndDelete(disableUndoVerified, userId),
  setPasswordChangeVerified: (userId) => set(passwordChangeVerified, userId),
  consumePasswordChangeVerified: (userId) =>
    getAndDelete(passwordChangeVerified, userId),
  setEmailChangeVerified: (userId) => set(emailChangeVerified, userId),
  consumeEmailChangeVerified: (userId) =>
    getAndDelete(emailChangeVerified, userId),
  setDeleteAccountVerified: (userId) => set(deleteAccountVerified, userId),
  consumeDeleteAccountVerified: (userId) =>
    getAndDelete(deleteAccountVerified, userId),
};
