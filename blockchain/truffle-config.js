...
module.exports = {
  ...
  networks: {
    ...
    ganache: {
      ...
      port: parseInt(process.env.GANACHE_PORT || "8545"),
    ...
    // NB: It's important to wrap the provider as a function to ensure truffle uses a new provider every time.
    // ropsten: {
  ...
  // false to: true. The default storage location can also be overridden by
  // specifying the adapter settings, as shown in the commented code below.
  //
