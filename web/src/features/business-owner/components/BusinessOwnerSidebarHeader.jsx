...
import { Avatar, Dropdown, Menu, Space, Typography, Badge, Button, Tag, theme, Spin, Grid } from 'antd'
  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {typeof title === 'string' && (
          <Text strong style={{ fontSize: isMobile ? 13 : 14, textTransform: 'capitalize' }}>{title}</Text>
        )}
        {businessName && (
