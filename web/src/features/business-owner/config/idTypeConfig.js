...
export const ID_TYPES = {
  ...
  drivers_license: {
    ...
    fields: [
      ...
      { name: 'nationality', label: 'Nationality', required: true, defaultValue: 'PHL' },
      { name: 'sex', label: 'Sex', type: 'select', options: ['M', 'F'], required: true },
      { name: 'dateOfBirth', label: 'Date of Birth', type: 'date', required: true },
      // Address fields - structured for Philippine addresses
      { name: 'streetAddress', label: 'House/Bldg No. & Street', required: true, placeholder: 'e.g., 133 ROXAS BOULEVARD' },
      { name: 'barangay', label: 'Barangay', required: true, placeholder: 'e.g., POBLACION' },
      { name: 'city', label: 'City/Municipality', required: true, placeholder: 'e.g., SAN CARLOS CITY' },
      { name: 'province', label: 'Province', required: true, placeholder: 'e.g., PANGASINAN' },
      { name: 'postalCode', label: 'Postal Code', required: true, placeholder: 'e.g., 2420', pattern: /^\d{4}$/, patternMessage: 'Postal code must be 4 digits' },
      { name: 'expiryDate', label: 'Expiration Date', type: 'date', required: true },
      { name: 'agencyCode', label: 'Agency Code', required: true, placeholder: 'e.g., A12' },
      { name: 'bloodType', label: 'Blood Type', required: false, placeholder: 'e.g., O+' },
      { name: 'dlCodes', label: 'DL Codes', required: true, placeholder: 'e.g., A, A1, B, B1, B2' },
    ...
    ocrMapping: {
      ...
      sex: ['sex', 'kasarian', 'gender', 'sex/gender', 'm/f', 'male', 'female'],
      ...
      agencyCode: ['agency code', 'agency', 'a12', 'lto code', 'office code'],
      bloodType: ['blood type'],
      dlCodes: ['dl codes', 'restrictions', 'license code', 'codes', 'vehicle codes', 'a1', 'b1', 'b2'],
