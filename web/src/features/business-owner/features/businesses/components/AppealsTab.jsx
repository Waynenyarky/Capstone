...
import AppealModal from '@/features/business-owner/features/appeals/components/AppealModal'
import { useAppeals } from '@/features/business-owner/features/appeals/hooks/useAppeals'
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        <div>
          <Title level={5} style={{ color: token.colorPrimary, margin: 0 }}>Appeals & Disputes</Title>
          <Paragraph type="secondary" style={{ marginBottom: 0 }}>Contest rejected permits, fines, or inspection results.</Paragraph>
        </div>
      ...
      <AppealModal open={isModalVisible} onCancel={closeModal} onSubmit={handleCreate} />
    </div>
  )
}
