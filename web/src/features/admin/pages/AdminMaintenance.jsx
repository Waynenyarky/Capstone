...
import { Card, Form, Input, DatePicker, Select, Button, Space, Typography, Table, Tag, Modal } from 'antd'
...
export default function AdminMaintenance() {
  ...
  return (
    <AdminLayout pageTitle="Maintenance Control" pageIcon={<ToolOutlined />}>
      <div style={{ padding: 24 }}>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <Card title="Pending/Recent Requests">
            <Table rowKey="approvalId" dataSource={approvals} columns={columns} pagination={false} scroll={{ x: 'max-content' }} />
          </Card>
        </Space>
      </div>
    </AdminLayout>
