...
const NAV_ITEMS = [
  ...
  { key: 'logs', label: 'History', icon: FileTextOutlined },
  { key: 'fee-by-lob', label: 'Fee by Line of Business', icon: UnorderedListOutlined },
  { key: 'special-fees', label: 'Special fees', icon: SafetyCertificateOutlined },
  { key: 'penalty', label: 'Penalty & Surcharge', icon: ScheduleOutlined },
]

export default function FeeConfigurationDesktopView({
  tabKey,
  setTabKey,
  tabChildren,
  headerActions,
