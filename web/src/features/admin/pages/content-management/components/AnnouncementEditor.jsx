...
export default function AnnouncementEditor({ selected, saving, onSave, onDelete, audience }) {
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end', alignItems: 'center', minWidth: 0 }}>
          ...
          {selected.status === 'published' && (
            <Button icon={<RollbackOutlined />} onClick={() => handleSave(false)} loading={saving}>
              Unpublish
            </Button>
          )}
        </div>
