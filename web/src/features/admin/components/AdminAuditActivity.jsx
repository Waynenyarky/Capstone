...
import { Card, Table, Tag, Space, Typography, DatePicker, Select, Button, Tooltip, Grid } from 'antd'
    ...
    <Card
      ...
      extra={
        <Space wrap size="small">
          <RangePicker value={dateRange} onChange={setDateRange} size={isMobile ? 'small' : 'middle'} />
          <Select
            allowClear
            placeholder="Event type"
            style={{ width: isMobile ? 140 : 160, minWidth: isMobile ? undefined : 160 }}
            value={eventType}
