...
export const WelcomeStep = {
  ...
  parameters: {
    storyDescription: 'Step 0: Welcome screen - Staff user sees welcome message and "Get Started" button',
  },
}
...
export const PasswordStep = {
  ...
  parameters: {
    storyDescription: 'Step 1: Set new password - Staff user enters new password with strength indicator',
  },
}
...
export const CompleteStep = {
  ...
  parameters: {
    storyDescription: 'Step 3: Complete - Staff user sees success message and button to go to staff dashboard',
  },
}
...
export const FullFlow = {
  render: () => <OnboardingShell initialStep={0} />,
  parameters: {
    storyDescription: 'Interactive: Click through the complete staff onboarding flow from Welcome → Password → MFA → Complete',
  },
}
