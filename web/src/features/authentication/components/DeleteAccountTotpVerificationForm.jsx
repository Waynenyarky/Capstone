...
import { useDeleteAccountTotpVerification } from '@/features/authentication/hooks'

const { Title, Text } = Typography

export default function DeleteAccountTotpVerificationForm({ email, onSubmit, onBack }) {
  const [form] = Form.useForm()
  const { isSubmitting, handleFinish } = useDeleteAccountTotpVerification({ 
    email, 
    onSubmit,
    form 
  })
  ...
  return (
    <div style={{ maxWidth: 400, margin: '0 auto', width: '100%' }}>
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        ...
        <Text type="secondary">
          Enter the authentication code from your authenticator app to continue with account deletion.
        </Text>
      </div>
