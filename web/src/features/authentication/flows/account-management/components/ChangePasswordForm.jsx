...
import { changeConfirmPasswordRules as confirmPasswordRules, changePasswordRules as passwordRules } from "@/features/authentication/utils/validations"
    ...
    <div style={{ maxWidth: 300, margin: '0 auto', width: '100%' }}>
      ...
      <Form name="changePassword" form={form} size="default" layout="vertical" onFinish={handleFinish} requiredMark={false}>
        ...
        <Form.Item style={{ marginBottom: 32 }}>
          <Button type="primary" htmlType="submit" loading={isSubmitting} disabled={isButtonDisabled()} block>
            {isResetFlow
              ? 'Reset Password'
